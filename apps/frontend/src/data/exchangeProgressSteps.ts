...
export interface ProgressStep {
  ...
  description: string;
  status: StepStatus;
  routeOrLocation?: string; // e.g. /dashboard/spot, POST /api/v1/spot/order
}
...
export const EXCHANGE_PROGRESS_STEPS: ProgressStep[] = [
  ...
  // --- Spot Frontend ---
  { id: 'sf-1', category: 'spot_frontend', title: 'Place order (limit + market)', titleHindi: 'Order place (limit + market)', description: 'Frontend uses POST /spot/order with matching.', status: 'done', routeOrLocation: '/dashboard/spot' },
  ...
  { id: 'sf-3', category: 'spot_frontend', title: 'Chart interval switch (1m/5m/15m/1H/4H/1D)', titleHindi: 'Chart interval switch', description: 'Click se interval change, candles refetch.', status: 'done', routeOrLocation: '/dashboard/spot' },
  { id: 'sf-4', category: 'spot_frontend', title: 'Trade markers on chart', titleHindi: 'Chart par trade markers', description: 'Executed trades as buy/sell markers on chart.', status: 'done', routeOrLocation: '/dashboard/spot' },
  ...
  // --- P2P Frontend ---
  { id: 'pf-1', category: 'p2p_frontend', title: 'Ads list, filters, create ad', titleHindi: 'Ads list + create', description: 'P2P trading page.', status: 'done', routeOrLocation: '/dashboard/p2p' },
  { id: 'pf-2', category: 'p2p_frontend', title: 'Create order, confirm, release, cancel', titleHindi: 'Order flow', description: 'Order detail page actions.', status: 'done', routeOrLocation: '/dashboard/p2p/orders/[id]' },
  { id: 'pf-3', category: 'p2p_frontend', title: 'Payment methods CRUD', titleHindi: 'Payment methods', description: 'List, add, edit.', status: 'done', routeOrLocation: '/dashboard/p2p/payment-methods' },
  { id: 'pf-4', category: 'p2p_frontend', title: 'P2P order chat UI', titleHindi: 'P2P order chat UI', description: 'Chat component on order detail (after backend).', status: 'done', routeOrLocation: '/dashboard/p2p/orders/[id]' },
  // --- General ---
