  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400 text-sm mt-1">P2P marketplace overview</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-4">
          ...
          <p className="text-xs text-gray-500">{data?.adsStats?.active_ads || 0} active</p>
        </div>
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
          ...
          <p className="text-xs text-gray-500">{data?.orderStats?.active_orders || 0} in progress</p>
        </div>
        ...
        <div className={`${(data?.disputeStats?.open_disputes || 0) > 0 ? 'bg-red-500/10 border-red-500/30' : 'bg-gray-800/50 border-gray-700'} border rounded-xl p-4`}>
          ...
          {(data?.disputeStats?.open_disputes || 0) > 0 && (
            <Link href="/admin/p2p/disputes" className="text-xs text-red-400 hover:underline">
              View disputes →
            </Link>
          )}
        </div>
