...
export default function PendingWithdrawalsPage() {
  ...
  useEffect(() => {
    ...
    fetch(`${apiUrl}/api/v1/admin/withdrawals?status=pending&limit=100`)
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400 text-sm mt-1">Withdrawals awaiting processing. Sign and broadcast from hot wallet to complete.</p>
