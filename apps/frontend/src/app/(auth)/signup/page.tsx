        ...
        <form onSubmit={(e) => { e.preventDefault(); completeSignup(); }} className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex gap-1">
              <div className={`h-1 flex-1 rounded-full transition-colors ${password.length >= 8 ? 'bg-primary' : 'bg-accent'}`} />
              <div className={`h-1 flex-1 rounded-full transition-colors ${/[A-Z]/.test(password) && /[a-z]/.test(password) ? 'bg-primary' : 'bg-accent'}`} />
