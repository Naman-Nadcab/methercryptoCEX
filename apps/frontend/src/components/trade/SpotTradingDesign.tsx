              ...
              {TIMEFRAMES.map((tf, i) => (
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded transition-colors ${
                    i === 2 ? 'bg-card/10 text-white' : 'text-muted-foreground hover:text-muted-foreground hover:bg-card/5'
                  }`}
                >
                  {tf}
                </button>
              ...
              {ORDER_TYPES.map((t, i) => (
                <button
                  ...
                  className={`flex-1 py-2 text-xs font-medium rounded transition-colors ${
                    orderType === i ? 'bg-card/10 text-white' : 'text-muted-foreground hover:text-muted-foreground hover:bg-card/5'
                  }`}
                >
                  {t}
                </button>
