    ...
    <div className="flex h-screen w-full flex-col overflow-hidden bg-gray-50 text-gray-900 dark:bg-[#0b0e11] dark:text-gray-100">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden p-2 sm:p-3">
        ...
        >
          ...
          <div className="flex min-h-0 min-w-0 flex-col gap-2 rounded-lg border border-gray-200/90 bg-white shadow-sm dark:border-gray-800/90 dark:bg-[#181a20] dark:shadow-none md:col-start-2 md:row-start-1 md:row-span-2 lg:col-start-3 lg:row-start-1 lg:row-span-2">
