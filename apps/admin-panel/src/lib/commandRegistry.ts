...
const NAV_COMMANDS: CommandEntry[] = [
  ...
  { id: 'nav-audit', label: 'Audit Logs', description: 'System audit trail', category: 'navigate', icon: 'FileText', href: '/audit', keywords: ['audit', 'log', 'trail', 'history'], group: 'Compliance' },
  { id: 'nav-audit-config', label: 'Audit Configuration', description: 'Config change audit log', category: 'navigate', icon: 'Sliders', href: '/audit/config', keywords: ['audit', 'config', 'change', 'history'], group: 'Compliance' },
