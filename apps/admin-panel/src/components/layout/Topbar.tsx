  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-admin-border bg-white px-6">
      <div className="flex flex-1 items-center gap-6">
        <div className="relative w-full max-w-md">
          ...
          <input
            ...
            className="w-full rounded-lg border border-admin-border bg-gray-50 py-2 pl-10 pr-4 text-sm placeholder:text-admin-muted focus:border-admin-primary focus:outline-none focus:ring-1 focus:ring-admin-primary"
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 rounded-lg border border-admin-border bg-gray-50/80 px-3 py-1.5">
        ...
        <button
          type="button"
          className="rounded-lg p-2 text-admin-muted hover:bg-gray-100 hover:text-gray-900"
          aria-label="Notifications"
        >
          <Bell className="h-5 w-5" />
        </button>

        <div className="flex items-center gap-2 rounded-lg border border-admin-border bg-gray-50/80 px-3 py-2">
