...
const PLAYBOOKS: Record<string, Playbook> = {
  Engine: {
    ...
    steps: [
      { action: 'Check matching engine health at /trading', priority: 'immediate' },
  ...
  API: {
    ...
    steps: [
      { action: 'Check API error rate at /monitoring', priority: 'immediate' },
  ...
  Wallets: {
    ...
    steps: [
      { action: 'Check pending withdrawals at /withdrawals', priority: 'immediate' },
  ...
  Risk: {
    ...
    steps: [
      { action: 'Review open AML alerts at /risk', priority: 'immediate' },
  ...
  Security: {
    ...
    steps: [
      { action: 'Check failed login patterns at /risk', priority: 'immediate' },
  ...
  Settlement: {
    ...
    steps: [
      { action: 'Check settlement queue depth at /monitoring', priority: 'immediate' },
...
const GENERIC_PLAYBOOK: Playbook = {
  ...
  steps: [
    ...
    { action: 'Check /monitoring for overall status', priority: 'immediate' },
