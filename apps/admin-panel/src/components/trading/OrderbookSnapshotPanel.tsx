  ...
  return (
    <Card>
      <CardContent className="p-6">
        <h2 className="text-lg font-semibold text-gray-900">Orderbook Snapshot</h2>
        <div className="mt-4 flex flex-wrap items-center gap-4">
          ...
          {spreadPct != null && (
            <div className="rounded-lg border border-admin-border bg-gray-50/50 px-3 py-2">
              <span className="text-xs font-medium text-admin-muted">Spread: </span>
              <span className="text-sm font-semibold text-gray-900">{spreadPct}%</span>
            </div>
          )}
          <div className="rounded-lg border border-admin-border bg-gray-50/50 px-3 py-2">
            <span className="text-xs font-medium text-admin-muted">Depth: </span>
            <span className="text-sm font-semibold text-gray-900">{depth}</span>
          </div>
        </div>
        {isLoading ? (
